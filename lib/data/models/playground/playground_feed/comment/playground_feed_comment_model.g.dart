...
_$_PlaygroundFeedCommentModel _$$_PlaygroundFeedCommentModelFromJson(
        Map json) =>
    _$_PlaygroundFeedCommentModel(
      ...
      replies: (json['replies'] as List<dynamic>?)
          ?.map((e) => PlaygroundFeedCommentReplyModel.fromJson(
...
Map<String, dynamic> _$$_PlaygroundFeedCommentModelToJson(
        _$_PlaygroundFeedCommentModel instance) =>
    <String, dynamic>{
      'id': instance.id,
